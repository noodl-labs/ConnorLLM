...
func TestEvaluateCase_successNoJSON(t *testing.T) {
	...
	result, err := EvaluateCase(context.Background(), "ping", false, testRequest(t), timeout, retry, fake)
...
func TestEvaluateCase_invalidJSON(t *testing.T) {
	...
	result, err := EvaluateCase(context.Background(), "json-case", true, testRequest(t), timeout, retry, fake)
	if err != nil {
		t.Fatal(err)
	}
	if result.Passed {
...
func TestEvaluateCase_validJSON(t *testing.T) {
	...
	result, err := EvaluateCase(context.Background(), "json-ok", true, testRequest(t), timeout, retry, fake)
...
func TestEvaluateCase_callFailedTimeout(t *testing.T) {
	...
	result, err := EvaluateCase(context.Background(), "slow", true, testRequest(t), timeout, retry, fake)
